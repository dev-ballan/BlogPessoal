...
public class UsuarioControllerTest {
	...
	@Autowired
	private TestRestTemplate testRestTemplate; // CRIA REQUISIÇÕES (INSOMNIA)
	...
	public void deveCriarUmUsuario() {
		...
		// JSON que inserimos no Insomnia
		...
		// a Resposta esperada (objeto da Class Usuario Persisto no BD)
